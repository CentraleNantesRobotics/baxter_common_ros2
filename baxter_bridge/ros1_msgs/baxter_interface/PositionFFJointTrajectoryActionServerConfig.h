...
namespace baxter_interface
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(PositionFFJointTrajectoryActionServerConfig &config, const PositionFFJointTrajectoryActionServerConfig &max, const PositionFFJointTrajectoryActionServerConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const PositionFFJointTrajectoryActionServerConfig &config1, const PositionFFJointTrajectoryActionServerConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, PositionFFJointTrajectoryActionServerConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const PositionFFJointTrajectoryActionServerConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, PositionFFJointTrajectoryActionServerConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const PositionFFJointTrajectoryActionServerConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const PositionFFJointTrajectoryActionServerConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, PositionFFJointTrajectoryActionServerConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
